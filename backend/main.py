...
async def lifespan(app: FastAPI):
    ...
    # LINEAJE: enforce() `_lineaje_payload` at agent->log log_emit — scan flagged AI_APP_SEC_039 (Sanitize and validate all input to the AI Model.); AI_APP_SEC_040 (Do not allow malicious content via prompts included in uploaded files.); AI_APP_SEC_059 (Do not allow prompts that can execute malicious commands at runtime.). Mask/block; do not remove without review. site_id='site:sha256:52cd5e1563c281eb59175707ccd3688da21f3c7a1de4047fed405493384d0487'
