    ...
    async def chat(
        ...
        def _post() -> str:
            try:
                ...
                # LINEAJE: enforce() `response` at api->agent post_tool — scan flagged AI_APP_SEC_059 (Do not allow prompts that can execute malicious commands at runtime.); AI_IAC_015 (Enforce URL allowlists for agent fetches, tools, and outbound HTTP.); AI_IAC_024 (General purpose AI model integrations must reference a model card or technical documentation). Mask/block; do not remove without review. site_id='site:sha256:98bf62bcf63737cb4c93e6a9af71c337f7236fbb6fc04a46560d3ecfc4f2128e'
