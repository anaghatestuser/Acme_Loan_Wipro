...
class BedrockClient:
    ...
    def __init__(
        ...
        if not (self.region or self.session.region_name):
            ...
            # LINEAJE: enforce() `_lineaje_payload` at agent->log log_emit — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.). Mask/block; do not remove without review. site_id='site:sha256:b789cb324461f8c8c05fd970cb37c76fff0c9bcc5b1515135b3e61342c486927'
    ...
    async def chat(
        ...
        # LINEAJE: enforce() `_lineaje_payload` at agent->log log_emit — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.). Mask/block; do not remove without review. site_id='site:sha256:d70f9b70d98a31611210c1895d1372cc6efa22d9dde78c6d8f8254d32e0744a8'
        _gr_client = _lineaje_load_gr_client()
        ...
        try:
            ...
            # LINEAJE: enforce() `_lineaje_payload` at agent->log log_emit — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.). Mask/block; do not remove without review. site_id='site:sha256:43e225ac3346508e712e780a2bb0e8264d51c926772fdd2565befccc6952138b'
            _gr_client = _lineaje_load_gr_client()
            ...
            # LINEAJE: enforce() `content` at agent->user_interface data_egress — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.). Mask/block; do not remove without review. site_id='site:sha256:f392b250728788b8ffc3037279c6c6bc1d8bec66609e94e41317f573cd756a15'
            _gr_client = _lineaje_load_gr_client()
            ...
            # LINEAJE: enforce() `_lineaje_payload` at agent->log log_emit — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.). Mask/block; do not remove without review. site_id='site:sha256:ebda275c14f8ee88c0f2cfdda8d5a52a2f53ab8d3be166e4804e0464eb421014'
            _gr_client = _lineaje_load_gr_client()
            ...
            # LINEAJE: enforce() `_lineaje_payload` at agent->log log_emit — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.). Mask/block; do not remove without review. site_id='site:sha256:8cde1a8d0d285a32dae5735e51d17994c4ba539700dca8f4f381e12d06bd4693'
            _gr_client = _lineaje_load_gr_client()
            ...
            # LINEAJE: enforce() `_lineaje_payload` at agent->log log_emit — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.). Mask/block; do not remove without review. site_id='site:sha256:37426a142855944df9754ce405cb36930f8dd3f4a19638675ee54fd5a0e4c51b'
            _gr_client = _lineaje_load_gr_client()
            ...
            # LINEAJE: enforce() `_lineaje_payload` at agent->log log_emit — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.). Mask/block; do not remove without review. site_id='site:sha256:a9982e7f1618bc84e61b2307d7b163adc9c25c05495e8e3e6fd3160069f0f941'
            _gr_client = _lineaje_load_gr_client()
