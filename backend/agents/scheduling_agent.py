...
class SchedulingAgent(AcmeLoanAgentFramework):
    ...
    async def call_agent_model(self, user_message: str, meeting_reference: str) -> str:
        ...
        # LINEAJE: enforce() `_lineaje_messages` at html->user_interface data_egress — scan flagged AI_APP_SEC_059 (Do not allow prompts that can execute malicious commands at runtime.); AI_IAC_024 (General purpose AI model integrations must reference a model card or technical documentation). Mask/block; do not remove without review. site_id='site:sha256:e2852fec9853abb0ec93501ce690722ecd47f7ba4fefccf81d2c7a8626779616'
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:e2852fec9853abb0ec93501ce690722ecd47f7ba4fefccf81d2c7a8626779616', phase='data_egress', boundary={'source': 'html', 'sink': 'user_interface'}, candidate_policies=[{'policy_id': 'AI_DAT_SEC_012', 'guardrail_id': 'Mask PII on UI', 'policy_version': '2026.08.1'}, {'policy_id': 'AI_APP_SEC_059', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_IAC_024', 'guardrail_id': None, 'policy_version': None}], fail_mode='BLOCK', source_type='html', destination_type='user_interface')
