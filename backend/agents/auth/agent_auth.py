...
class AgentAuthenticator:
    ...
    def generate_token(self, identity: AgentIdentity) -> str:
        ...
        # LINEAJE: enforce() `token` at agent->user_interface data_egress — scan flagged AI_IAC_007 (Inter-agent communication must be authenticated.); AI_IAC_016 (Detect and block agent privilege escalation attempts.); AI_VULN_SEC_001 (Do not allow critical or high vulnerabilities in the code.). Mask/block; do not remove without review. site_id='site:sha256:36f644a7be0cc7cd10405df277ca910440a0286661d10fd343b39d0446407c18'
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:36f644a7be0cc7cd10405df277ca910440a0286661d10fd343b39d0446407c18', phase='data_egress', boundary={'source': 'agent_message', 'sink': 'user_interface'}, candidate_policies=[{'policy_id': 'AI_DAT_SEC_012', 'guardrail_id': 'Mask PII on UI', 'policy_version': '2026.08.1'}, {'policy_id': 'AI_IAC_007', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_IAC_016', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_VULN_SEC_001', 'guardrail_id': None, 'policy_version': None}], fail_mode='BLOCK', source_type='agent', destination_type='user_interface')
