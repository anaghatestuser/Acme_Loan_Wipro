...
async def call_mcp_server(
    ...
    def _post() -> dict[str, Any]:
        try:
            ...
            # LINEAJE: enforce() `response` at api->agent post_tool — scan flagged AI_IAC_007 (Inter-agent communication must be authenticated.); AI_IAC_015 (Enforce URL allowlists for agent fetches, tools, and outbound HTTP.). Mask/block; do not remove without review. site_id='site:sha256:f87bf0b02e4dd7d487508bbc4ab603ccde64d095b0be2edce2464a63d343bbad'
