...
async def call_mcp_server(
    ...
    def _post() -> dict[str, Any]:
        try:
            ...
            # LINEAJE: enforce() `response` at api->agent post_tool — scan flagged AI_IAC_007 (Inter-agent communication must be authenticated.). Mask/block; do not remove without review. site_id='site:sha256:f87bf0b02e4dd7d487508bbc4ab603ccde64d095b0be2edce2464a63d343bbad'
            _gr_client = _lineaje_load_gr_client()
            _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:f87bf0b02e4dd7d487508bbc4ab603ccde64d095b0be2edce2464a63d343bbad', phase='post_tool', boundary={'source': 'external_endpoint', 'sink': 'agent_message'}, candidate_policies=[{'policy_id': 'AI_IAC_007', 'guardrail_id': None, 'policy_version': None}], fail_mode='ALLOW_WITH_AUDIT', source_type='api', destination_type='agent')
