...
def apply_firewall_rule(rule: str) -> str:
    # LINEAJE: enforce() `rule` at agent->log log_emit — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.); AI_APP_SEC_059 (Do not allow prompts that can execute malicious commands at runtime.); AI_APP_SEC_066 (Do not allow malicious content via prompts included in source files.). Mask/block; do not remove without review. site_id='site:sha256:97b073d6d379d2b2328f9884baa2207eeb8689344693fdb10e5082b7a344d834'
    _gr_client = _lineaje_load_gr_client()
...
def _parse_decision_block(raw: str) -> dict[str, str]:
    ...
    # LINEAJE: enforce() `parsed` at agent->user_interface data_egress — scan flagged AI_APP_SEC_006 (Use only LLMs from the organization's approved list.); AI_APP_SEC_059 (Do not allow prompts that can execute malicious commands at runtime.); AI_APP_SEC_066 (Do not allow malicious content via prompts included in source files.). Mask/block; do not remove without review. site_id='site:sha256:096b8164fd151d0c0c8b867d8bf85edb4106e49126f825437f7888597ca216b8'
    _gr_client = _lineaje_load_gr_client()
...
class AccessControlAgent(AcmeLoanAgentFramework):
    ...
    async def decide_security(self, user_id: str, user_message: str) -> dict[str, str]:
        ...
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:ae5bdc0ce5bdc9f7ed8734c39863a600e3432ea3630ceccf0994a4335aad5687', phase='data_egress', boundary={'source': 'agent_message', 'sink': 'user_interface'}, candidate_policies=[{'policy_id': 'AI_DAT_SEC_012', 'guardrail_id': 'Mask PII on UI', 'policy_version': '2026.08.1'}, {'policy_id': 'AI_APP_SEC_006', 'guardrail_id': 'Enforce Approved LLM.', 'policy_version': '2026.08.1'}, {'policy_id': 'AI_APP_SEC_059', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_APP_SEC_066', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_APP_SEC_068', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_APP_SEC_070', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_IAC_014', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_IAC_016', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_IAC_023', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_IAC_024', 'guardrail_id': None, 'policy_version': None}, {'policy_id': 'AI_VULN_SEC_001', 'guardrail_id': None, 'policy_version': None}], fail_mode='BLOCK', source_type='agent', destination_type='user_interface')
